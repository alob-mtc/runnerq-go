...
- **Durable awaits** - Parents awaiting children, durable timers, and signal waits park as database rows instead of holding workers — workflows survive crashes, restarts, and deploys
